...
def main():
    ...
    # Validate acceleration argument
    ...
    try:
        tour, ship_time, sol_time, leg_details = star_tsp.solve_tdtsp_nearest_neighbor(all_stars, args.start_star, args.acceleration)
        ...
        print(f"Assumptions: {args.acceleration}g constant accel/decel, 1-year stay at each destination.")
    ...
    # Stop the counter and print the elapsed time for calculation and preparation
    end_time = time.perf_counter()
    star_tsp.print_execution_time(start_time, end_time)
